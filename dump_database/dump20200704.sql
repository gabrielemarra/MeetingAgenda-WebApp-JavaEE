CREATE DATABASE  IF NOT EXISTS `gestione-riunioni` /*!40100 DEFAULT CHARACTER SET utf8 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `gestione-riunioni`;
-- MySQL dump 10.13  Distrib 8.0.19, for Win64 (x86_64)
--
-- Host: localhost    Database: gestione-riunioni
-- ------------------------------------------------------
